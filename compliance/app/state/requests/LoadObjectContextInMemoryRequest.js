//@charset UTF-8
Ext.define('compliance.state.requests.LoadObjectContextInMemoryRequest', {
    ...
    setObjectContextSynchronizer: function() {
        ...
        this.requestObject = {
            method: 'GET',
            url: '/maestro/resources/clienttree/objectcontext/objecttypes/' + this.getObjectContextSynchronizer().objectTypeId + '/objectheaders/refresh',
